...
export default function Wallet() {
    const [state, { dispatch, handleConnect }] = useBlockchainContext();

    return (
        <div className="row">
            <div className="col-lg-3 mb30">
                <span className="box-url">
                    <div onClick={() => handleConnect("injected")}>
            ...
            {/* <div className="col-lg-3 mb30">
                <span className="box-url">
                    <div onClick={() => handleConnect("walletlink")}>
                        <img src="./img/wallet/5.png" alt="" className="mb20" />
                        <h4>Coinbase Wallet</h4>
                        <p>
                            The easiest and most secure crypto wallet. ... No
